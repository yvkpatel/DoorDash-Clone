...
class DataAccess:
    ...
    def addDriver(self, username, passHash, name):
        try:
            if self.gatewayUtil.isUsernameUnique(username, self.authGatewayCNX):
                ...
                newDriver = Driver(driverID, username, name, False, [], 0.00, 0.00)
    ...
    # @returns
    #           Type: Order Array
    #           Description: all orders in restaurant
    def getDriverOrders(self, driverID):
        try:
            orderIDs = self.driverGateway.getOrders(driverID)
            if orderIDs is None:
                return None
            orders = []
    ...
    #           Type: Order Array
    #           Description: all orders in restaurant
    def getDriverLocation(self, driverID):
        try:
            driver = self.driverGateway.getDriverProfileFromID(driverID)
            return {'long': driver.getLong(), 'lat': driver.getLat()}
        except Exception as e:
            print(e)
            return None
    ...
    #           Type: Order Array
    #           Description: all orders in restaurant
    def setDriverLocation(self, driverID, long, lat):
        try:
            return self.driverGateway.setDriverLocation(driverID, long, lat)
        except Exception as e:
            print(e)
            return None
    ...
    def addItemToRestaurant(self, restaurantID, name, category, cost, prepTime, calories, description, imageLink):
        try:
            itemID = "I" + str(randint(100, 999))
            item = Item(itemID, name, category, cost, prepTime, calories, description, imageLink)
    ...
    #           Type: Order Array
    #           Description: all orders in restaurant
    def getRestaurantOrders(self, restID):
        try:
            orderIDs = self.restaurantGateway.getOrderIDs(restID)
            if orderIDs is None:
                return None
            orders = []
            for orderID in orderIDs:
    ...
    # @returns
    #           Type: Menu
    #           Description: menu in restaurant
    def getRestaurantMenu(self, restID):
        try:
            menuID = self.restaurantGateway.getMenuID(restID)
            menu = self.menuGateway.getMenu(menuID)
            return menu
        except Exception as e:
            print(e)
            return None
    ...
    def addOrder(self, cost, items, status, prepTime, eta, deliveryAddress,
                 ccNumber, cvv, exp, firstName, lastName, postal, restID, custID):
        try:
            ...
            newOrder = Order(orderID, cost, items, status, prepTime, eta, deliveryAddress, paymentInfo, False, restID, custID, "", [], [])
    ...
    def assignDriverToOrder(self, orderID, driverID):
        try:
            ...
            self.driverGateway.addOrder(driverID, orderID)
            return True
        except Exception as e:
            print(e)
            return False
    ...
    def updateOrderStatus(self, orderID, status):
        try:
            self.orderGateway.updateOrderStatus(orderID, status)
            return True
        except Exception as e:
            print(e)
            return False
    ...
    #           Type: Order (see data structure)
    #           Description: returns a order from id
    def addETAtoOrder(self, orderID, eta):
        try:
            self.orderGateway.addETA(orderID, eta)
            return True
        except Exception as e:
            print(e)
            return False
    ...
    #
    # @returns
    #           Type: Order Array (see data structure)
    #           Description: returns all unpaid orders
    def getUnpaidOrders(self):
        try:
            orders = self.orderGateway.getUnpaidOrders()
            if orders[0].getId() is None:
                return None
            return orders
        except Exception as e:
    ...
    # @returns
    #           Type: Order Array (see data structure)
    #           Description: returns all orders with no driver
    def getOrdersUnassignedDriver(self):
        try:
            orders = self.orderGateway.getUnassignedDriver()
            if orders[0].getId() is None:
                return None
            return orders
        except Exception as e:
    ...
    def getAllOrders(self):
        try:
            orders = self.orderGateway.getAllOrders()
            if orders[0].getId() is None:
                return None
            return orders
        except Exception as e:
    ...
    #           Type: bool
    #           Description:
    def updatePaymentFlag(self, orderID, paid: bool):
        try:
            self.orderGateway.updatePaymentFlag(orderID, paid)
            return True
        except Exception as e:
            print(e)
            return False
    ...
    def pushNotification(self, orderID, notification):
        try:
            self.orderGateway.pushNotification(orderID, notification)
            return True
        except Exception as e:
            print(e)
            return False
    ...
    #           Type: bool
    #           Description:
    def pushChat(self, orderID, receiver, datetime, message):
        try:
            chat = Chat(receiver, datetime, message)
            self.orderGateway.pushChat(orderID, chat)
            return True
        except Exception as e:
            print(e)
            return False
