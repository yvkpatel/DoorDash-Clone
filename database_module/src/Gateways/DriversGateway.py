...
class DriverGateway:
    ...
    def getDriverProfileFromID(self, driverID):
        ...
        driver = self.gatewayUtil.createDriver(response)
        return driver
    ...
    def getAvailableDrivers(self):
        ...
        for r in response:
            driver = self.gatewayUtil.createDriver(r)
    ...
    def getOrders(self, driverID):
        try:
            driver = self.cnx.find_one({'unique_id': driverID})
